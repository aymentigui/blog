...
import { Search, Filter, ArrowUpDown, Eye, Clock, X, Heart } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Badge } from "@/components/ui/badge"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"
import { useTranslations } from "next-intl"
import { fetchBlogs, fetchBlogsFavoris, fetchCategories } from "@/actions/blog/util-client"
...
export default function BlogPage() {
    ...
    useEffect(() => {
        fetchBlogsFavoris(setBlogs, setIsLoading, currentPage, articlesPerPage, setCount, debouncedSearchQuery, [], sortBy)
    ...
    useEffect(() => {
        fetchBlogsFavoris(setBlogs, setIsLoading, currentPage, 9, setCount, debouncedSearchQuery, [], sortBy)
    }, [])
        ...
        <Card className="p-4">
            <div className="container mx-auto py-12 px-4 md:px-6 relative">
                ...
                <motion.div initial="hidden" animate="visible" variants={fadeIn} className="text-center mb-12">
                    ...
                    <h1 className="text-4xl md:text-5xl mb-4 flex justify-center">
