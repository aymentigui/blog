...
export function DataTable({
    ...
    const hasPermissionAction = (session?.user?.permissions.find((permission: string) => permission === "projects_categories_update" || permission === "projects_categories_delete") ?? false) ||
