"use client"
import { DataTable } from "./data-table-projects-categories/data-table";
...
import { Columns } from "./data-table-projects-categories/columns-table";
import { DeleteProjectsCategories } from "@/actions/project/categories/delete";

type ProjectsCategoriesPageProps = {
  data: Columns[]
};

export default function ProjectsCategoriesPageList({ data }: ProjectsCategoriesPageProps) {
  ...
  const handleDelete = async () => {
    ...
    selectedIds.forEach(async (id) => {
      await DeleteProjectsCategories(id)
    })
