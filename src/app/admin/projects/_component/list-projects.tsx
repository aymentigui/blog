...
import { DataTable } from './data-table-projects/data-table'
...
import { getProjectsCount, getProjectsDesc } from '@/actions/project/get'
import { fetchCategories } from '@/actions/project/util-client'

const ListProjects = ({ hideFliterPageSize }: any) => {

    const translate = useTranslations("BlogPage")
    const translateSystem = useTranslations("System");
    const translateProject = useTranslations("Projects");
        ...
        <div>
            ...
            <div className='flex items-center justify-between'>
                <Button
                    ...
                    <PenLine /> {translateProject("myprojects")}
                </Button>
