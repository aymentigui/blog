...
import { fetchProjects, fetchCategories } from "@/actions/project/util-client"
import Loading from "@/components/myui/loading"
import TablePagination from "@/components/myui/table/pagination"
import CardProjectAnimate from "@/components/my/public/card-project-animate"
...
export default function ProjectPage() {
    ...
    useEffect(() => {
        fetchProjects(setProjects, setIsLoading, currentPage, 9, setCount, debouncedSearchQuery, selectedCategories, sortBy)
        ...
        <div className="container mx-auto py-12 px-4 md:px-6 relative">
            ...
            >
                ...
                <div className="relative max-w-md mx-auto">
                    ...
                    <Input
                        type="text"
                        placeholder={translate("searchplaceholder2")}
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 text-sm text-gray-500">
                    {count === 0 ? (
                        <p>{translate("noarticle2")}</p>
                    ) : (
                        <p>
                            {count} {count > 1 ? translate("projects") : translate("project")}{" "}
